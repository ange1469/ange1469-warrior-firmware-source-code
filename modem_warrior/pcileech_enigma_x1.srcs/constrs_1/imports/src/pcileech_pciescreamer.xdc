...
set_input_delay -clock [get_clocks net_clk] -min 6.500 [get_ports {ft601_data[*]}]
set_input_delay -clock [get_clocks net_clk] -max 7.000 [get_ports {ft601_data[*]}]
set_input_delay -clock [get_clocks net_clk] -min 6.500 [get_ports ft601_rxf_n]
set_input_delay -clock [get_clocks net_clk] -max 7.000 [get_ports ft601_rxf_n]
set_input_delay -clock [get_clocks net_clk] -min 6.500 [get_ports ft601_txe_n]
set_input_delay -clock [get_clocks net_clk] -max 7.000 [get_ports ft601_txe_n]

set_output_delay -clock [get_clocks net_clk] -max 1.000 [get_ports {ft601_wr_n ft601_rd_n ft601_oe_n}]
set_output_delay -clock [get_clocks net_clk] -min 4.800 [get_ports {ft601_wr_n ft601_rd_n ft601_oe_n}]
set_output_delay -clock [get_clocks net_clk] -max 1.000 [get_ports {{ft601_be[*]} {ft601_data[*]}}]
set_output_delay -clock [get_clocks net_clk] -min 4.800 [get_ports {{ft601_be[*]} {ft601_data[*]}}]
...
create_clock -period 10.000 -name pcie_refclk [get_nets i_pcileech_pcie_a7/pcie_clk_c]
