...
#                script (type 'fifo_32_32_clk1_comtx.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_32_32_clk1_comtx xil_defaultlib.glbl -o fifo_32_32_clk1_comtx_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_32_32_clk1_comtx_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo_32_32_clk1_comtx_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_32_32_clk1_comtx_simv.daidir vcs_lib c.obj)
