...
#
# Script generated by Vivado on Sat Sep 07 14:35:02 +0800 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_32_32_clk1_comtx.sh
...
#
# Usage        : fifo_32_32_clk1_comtx.sh
#                fifo_32_32_clk1_comtx.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_32_32_clk1_comtx.sh [-reset_run]
#                fifo_32_32_clk1_comtx.sh [-reset_log]
#                fifo_32_32_clk1_comtx.sh [-help]
#
...
# script info
echo -e "fifo_32_32_clk1_comtx.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_32_32_clk1_comtx.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_32_32_clk1_comtx xil_defaultlib.fifo_32_32_clk1_comtx xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_32_32_clk1_comtx -key {Behavioral:sim_1:Functional:fifo_32_32_clk1_comtx} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_32_32_clk1_comtx.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_32_32_clk1_comtx.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_32_32_clk1_comtx.sh [-help]\n\
Usage: fifo_32_32_clk1_comtx.sh [-step]\n\
Usage: fifo_32_32_clk1_comtx.sh [-lib_map_path]\n\
Usage: fifo_32_32_clk1_comtx.sh [-reset_run]\n\
Usage: fifo_32_32_clk1_comtx.sh [-reset_log]\n\
Usage: fifo_32_32_clk1_comtx.sh [-keep_index]\n\
Usage: fifo_32_32_clk1_comtx.sh [-noclean_files]\n\n\
