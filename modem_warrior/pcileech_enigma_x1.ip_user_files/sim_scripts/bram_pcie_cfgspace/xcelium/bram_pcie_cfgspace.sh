...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bram_pcie_cfgspace xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bram_pcie_cfgspace -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bram_pcie_cfgspace_sc.so .tmp_log xcelium_lib waves.shm c.obj)
