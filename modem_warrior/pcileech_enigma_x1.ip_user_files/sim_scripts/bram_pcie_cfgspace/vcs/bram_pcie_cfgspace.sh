...
#
# Script generated by Vivado on Thu Oct 10 14:38:48 +0200 2024
...
# script info
echo -e "bram_pcie_cfgspace.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_pcie_cfgspace xil_defaultlib.glbl -o bram_pcie_cfgspace_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_pcie_cfgspace_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_pcie_cfgspace_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_pcie_cfgspace_simv.daidir vcs_lib c.obj)
