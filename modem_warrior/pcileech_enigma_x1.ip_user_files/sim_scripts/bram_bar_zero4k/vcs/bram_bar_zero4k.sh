...
#                script (type 'bram_bar_zero4k.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_bar_zero4k xil_defaultlib.glbl -o bram_bar_zero4k_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_bar_zero4k_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_bar_zero4k_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_bar_zero4k_simv.daidir vcs_lib c.obj)
