...
#
# Script generated by Vivado on Thu Oct 10 14:39:00 +0200 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_bar_zero4k.sh
...
#
# Usage        : bram_bar_zero4k.sh
#                bram_bar_zero4k.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_bar_zero4k.sh [-reset_run]
#                bram_bar_zero4k.sh [-reset_log]
#                bram_bar_zero4k.sh [-help]
#
...
# script info
echo -e "bram_bar_zero4k.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_bar_zero4k.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_bar_zero4k xil_defaultlib.bram_bar_zero4k xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_bar_zero4k -key {Behavioral:sim_1:Functional:bram_bar_zero4k} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_bar_zero4k.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_bar_zero4k.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_bar_zero4k.sh [-help]\n\
Usage: bram_bar_zero4k.sh [-step]\n\
Usage: bram_bar_zero4k.sh [-lib_map_path]\n\
Usage: bram_bar_zero4k.sh [-reset_run]\n\
Usage: bram_bar_zero4k.sh [-reset_log]\n\
Usage: bram_bar_zero4k.sh [-keep_index]\n\
Usage: bram_bar_zero4k.sh [-noclean_files]\n\n\
